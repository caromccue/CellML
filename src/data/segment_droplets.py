...
def segment_skimage(img, exp_clip_limit=0.06, closing_disk_radius=4, rm_holes_area=8192, minima_minDist=100, mask_val=0.1, postsize = 85):
    '''
    ...
    postsize: size of posts in pixels, default 85 (for 5 um posts)
    Returns
    -------
