...
def segment(img, postsize=20, exp_clip_limit=15):
    '''
...
def extract_indiv_cells(img, labeled, border=25, area_upper_cutoff=4, area_lower_cutoff=4, ecc_cutoff=0.5, ecc_cutoff_upper=0.95):
    '''
