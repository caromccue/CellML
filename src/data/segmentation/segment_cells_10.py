...
def segment(img, postsize = 150, exp_clip_limit=30):
    '''
...
def extract_indiv_cells(img, labeled, border=35, area_upper_cutoff=1.5, area_lower_cutoff=2.5, ecc_cutoff=0.25):
    '''
